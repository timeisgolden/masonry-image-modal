...
@Component({
  selector: 'app-test-masonry',
  templateUrl: './test-masonry.component.html',
  styleUrls: ['./test-masonry.component.scss']
})
export class TestMasonryComponent implements OnInit, OnDestroy {
